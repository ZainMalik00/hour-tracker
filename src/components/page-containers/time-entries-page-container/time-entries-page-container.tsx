...
import styles from './time-entries-page-container.module.css';
...
interface TimeEntriesPageContainerProps {
  selectedDate: dayjs.Dayjs;
  onSelectedDateChange: (date: dayjs.Dayjs) => void;
  onTimeEntriesChange?: (length: number) => void;
}

const TimeEntriesPageContainer = ({ selectedDate, onSelectedDateChange, onTimeEntriesChange }: TimeEntriesPageContainerProps) => {
...
export default TimeEntriesPageContainer;
